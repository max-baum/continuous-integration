# Continuous Integration ![https://github.com/max-baum/continuous-integration/actions?query=workflow%3Atests](https://github.com/max-baum/continuous-integration/workflows/tests/badge.svg)
